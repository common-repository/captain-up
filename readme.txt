...
- **Localization** - out of the box support for over 18 languages.

- **Automatic support for WordPress User Integration and WordPress comments**
...
Yes. In order for the plugin to work you need to [sign up for Captain Up](http://captainup.com/).
